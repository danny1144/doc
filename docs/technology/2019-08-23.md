...
上面代码中，服务器同样用`Connection`字段通知浏览器，需要改变协议。`Sec-WebSocket-Accept`字段是服务器在浏览器提供的`Sec-WebSocket-Key`字符串后面，添加 [RFC6456](https://tools.ietf.org/html/rfc6455) 标准规定的“258EAFA5-E914-47DA-95CA-C5AB0DC85B11”字符串，然后再取 SHA-1 的哈希值。浏览器将对这个值进行验证，以证明确实是目标服务器回应了 WebSocket 请求。`Sec-WebSocket-Location`字段表示进行通信的 WebSocket 网址。
...
[ SVG 图像](https://wangdoc.com/webapi/svg.html)
...
- [ Canvas API](https://wangdoc.com/webapi/canvas.html)
- [ FontFace API](https://wangdoc.com/webapi/fontface.html)
- [ Geolocation API](https://wangdoc.com/webapi/geolocation.html)
...
- [ Server-Sent Events](https://wangdoc.com/webapi/server-sent-events.html)
- [ SVG 图像](https://wangdoc.com/webapi/svg.html)
- [ WebSocket](https://wangdoc.com/webapi/websocket.html)
- [ Web Share API](https://wangdoc.com/webapi/web-share-api.html)
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/webapi-tutorial/master/docs/websocket.md)
- [ 代码仓库](https://github.com/wangdoc/webapi-tutorial)
- 